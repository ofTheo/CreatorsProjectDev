...
void testApp::keyPressed(int key) {
	...
	if(key == '\t') {
		...
		if( !hidden &&  ofxFileHelper::doesFileExist("capture") ){
			...
			ofxFileHelper::moveFromTo("capture", "savedFolder"+unique);
			ofxFileHelper::makeDirectory("capture");
		}
